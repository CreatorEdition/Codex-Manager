...
pub(crate) const ENV_OVERRIDE_CATALOG: &[EnvOverrideCatalogItem] = &[
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_DB_AUTO_VACUUM_ENABLED",
        "空闲自动压缩数据库",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "0",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_DB_AUTO_VACUUM_IDLE_SECS",
        "自动压缩所需网关空闲秒数",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "3600",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_DB_AUTO_VACUUM_MIN_INTERVAL_SECS",
        "自动压缩最小间隔秒数",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "86400",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_DB_AUTO_VACUUM_MIN_FREE_MB",
        "自动压缩最小可回收空间 MB",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "128",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_DB_AUTO_VACUUM_MIN_FREE_PERCENT",
        "自动压缩最小空闲页百分比",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "25",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_DB_AUTO_VACUUM_WINDOW_START_HOUR",
        "自动压缩开始小时",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "",
    ...
    EnvOverrideCatalogItem::new(
        "CODEXMANAGER_DB_AUTO_VACUUM_WINDOW_END_HOUR",
        "自动压缩结束小时",
        ENV_OVERRIDE_SCOPE_SERVICE,
        ENV_OVERRIDE_APPLY_MODE_RUNTIME,
        "",
