...
export const KO_MESSAGES: MessageCatalog = {
  ...
  "出口 IP": "출구 IP",
  出口网络诊断: "출구 네트워크 진단",
  出口诊断刷新失败: "출구 진단 새로고침 실패",
  国家或地区: "국가 또는 지역",
  已使用最近的出口诊断结果: "최근 출구 진단 결과를 사용했습니다",
  已关闭: "비활성화됨",
  已开始刷新出口诊断: "출구 진단 새로고침을 시작했습니다",
  手动刷新: "수동 새로고침",
  "查询沿用当前 OpenAI 上游代理；外部诊断服务失败不会影响账号刷新或网关请求。":
    "조회는 현재 OpenAI 업스트림 프록시를 사용합니다. 외부 진단 서비스 실패는 계정 새로고침이나 게이트웨이 요청에 영향을 주지 않습니다.",
  "检测中...": "진단 중...",
  检测时间: "진단 시간",
  检测来源: "진단 소스",
  "用于核对当前服务出口，不会根据 IP 结果自动改变账号状态。":
    "현재 서비스의 출구를 확인하는 용도이며, IP 결과에 따라 계정 상태를 자동으로 변경하지 않습니다.",
  网络组织: "네트워크 조직",
  模型与路由: "모델 및 라우팅",
  成员管理: "멤버 관리",
  运行观测: "운영 관측",
  ...
  "当前为账号直连，Codex CLI 直连 OpenAI，CodexManager 无法统计 CLI 请求日志和用量。":
    "현재 계정 직결 모드입니다. Codex CLI가 OpenAI에 직접 연결되므로 CodexManager를 거치지 않은 요청은 요청 로그, 토큰, 비용 통계를 생성하지 않습니다.",
  "当前为本地网关，Codex CLI 经过 CodexManager 转发，请求日志、Token 和费用统计可用。":
    "현재 로컬 게이트웨이 모드입니다. Codex CLI 요청이 CodexManager를 통해 전달되므로 요청 로그, 토큰, 비용 통계를 사용할 수 있으며 게이트웨이 내부의 혼합 라우팅도 포함됩니다.",
  ...
  "当前未选择账号，本次将导出全部账号。":
    "선택된 계정이 없어 모든 계정을 내보냅니다.",
  "个账号。": "개 계정을 내보냅니다.",
  "当前存在搜索或筛选，请先勾选要导出的账号":
    "검색 또는 필터가 적용되어 있습니다. 먼저 내보낼 계정을 선택하세요.",
  ...
  "后端分页模式下请通过编辑顺序值调整账号排序":
    "백엔드 페이지네이션 모드에서는 순서 값을 편집해 전체 계정 순서를 조정하세요.",
  ...
  "计划类型筛选需要后端分页支持，已暂时停用":
    "플랜 유형 필터는 백엔드 페이지네이션 지원이 필요해 일시적으로 비활성화되었습니다.",
  全部状态: "전체 상태",
  账号操作: "계정 작업",
  刷新: "새로고침",
  刷新账号用量: "계정 사용량 새로고침",
  ...
  "个账号；确认后会清理全部匹配所选状态的账号":
    "개 계정이 현재 페이지에서 일치합니다. 확인하면 선택한 상태와 일치하는 모든 계정을 정리합니다.",
  删除选中账号: "선택 계정 삭제",
  ...
  "设为“跟随请求”时，不会额外改写 free / 单长周期窗口账号的模型；只有你选了具体模型后，命中这些账号时才会统一改写为该模型。":
    "“요청 따름”으로 설정하면 free/단일 장기 주기 창 계정의 모델을 추가로 변경하지 않으며, 구체 모델을 선택했을 때만 해당 계정이 그 모델로 변경됩니다.",
...
"个人资料已更新": "프로필이 업데이트되었습니다",
  ...
  "上游模型": "업스트림 모델",
  "实际来源": "실제 소스",
  "未经过本地网关的请求不会产生新的 CodexManager 请求日志": "로컬 게이트웨이를 거치지 않은 요청은 새로운 CodexManager 요청 로그를 생성하지 않습니다",
  "这里仅展示历史网关请求；如需记录请求，请让 CLI 请求经过 CodexManager 本地网关。": "여기에는 과거 게이트웨이 요청만 표시됩니다. 요청 로그가 필요하면 CLI 요청이 CodexManager 로컬 게이트웨이를 거치도록 하세요.",
  "去切换为本地网关": "로컬 게이트웨이로 전환",
  "仅网关流量": "게이트웨이 트래픽만",
  "账号直连模式下不会产生请求日志；本地网关或包含本地网关的混合路由才会记录。": "계정 직결 모드에서는 요청 로그가 생성되지 않습니다. 로컬 게이트웨이 또는 게이트웨이 내부의 혼합 라우팅만 기록됩니다.",
  "当前 CLI 直连 OpenAI，未经过 CodexManager 的请求不会产生请求日志、Token 和费用统计。":
    "현재 CLI는 OpenAI에 직접 연결됩니다. CodexManager를 거치지 않은 요청은 요청 로그, 토큰, 비용 통계를 생성하지 않습니다.",
  未分配: "미할당",
  ...
  "50 / 页": "50 / 페이지",
  "100 / 页": "100 / 페이지",
  "显示 {start}-{end} / {total}": "{start}-{end} / {total} 표시",
  刷新当前页余额: "현재 페이지 잔액 새로고침",
  "条聚合 API": "개의 집계 API",
  测试当前页: "현재 페이지 테스트",
  当前页Token: "현재 페이지 토큰",
  "当前页 Token": "현재 페이지 토큰",
  当前页费用: "현재 페이지 비용",
  按当前页平台密钥累计: "현재 페이지 platform key 기준 누적",
  按当前页我的密钥累计: "현재 페이지 내 키 기준 누적",
  "搜索名称、ID、模型或上游地址": "이름, ID, 모델 또는 업스트림 URL 검색",
  条平台密钥: "개의 platform key",
  没有匹配的密钥: "일치하는 키가 없습니다",
  代表样例: "대표 샘플",
  最后发生: "마지막 발생",
  次: "회",
  类错误: "오류 범주",
  ...
  "RPC requestlog/summary 超时：请求日志摘要查询超过 30 秒":
    "RPC requestlog/summary 시간 초과: 요청 로그 요약 조회가 30초를 초과했습니다",
  "RPC startup/snapshot 超时：启动快照查询超过 30 秒":
    "RPC startup/snapshot 시간 초과: 시작 스냅샷 조회가 30초를 초과했습니다",
};
