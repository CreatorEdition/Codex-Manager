...
export const EN_MESSAGES: MessageCatalog = {
  ...
  "出口 IP": "Egress IP",
  出口网络诊断: "Egress network diagnostics",
  出口诊断刷新失败: "Failed to refresh egress diagnostics",
  国家或地区: "Country or region",
  已使用最近的出口诊断结果: "Using the latest cached egress diagnostics",
  已关闭: "Disabled",
  已开始刷新出口诊断: "Egress diagnostics refresh started",
  手动刷新: "Refresh manually",
  "查询沿用当前 OpenAI 上游代理；外部诊断服务失败不会影响账号刷新或网关请求。":
    "The query uses the current OpenAI upstream proxy. External diagnostic service failures do not affect account refreshes or gateway requests.",
  "检测中...": "Checking...",
  检测时间: "Checked at",
  检测来源: "Source",
  "用于核对当前服务出口，不会根据 IP 结果自动改变账号状态。":
    "Used to verify the current service egress. The IP result never changes account status automatically.",
  ...
  "当前为账号直连，Codex CLI 直连 OpenAI，CodexManager 无法统计 CLI 请求日志和用量。":
    "Direct account mode is active. Codex CLI connects to OpenAI directly, so requests that bypass CodexManager do not produce request logs, token counts, or cost analytics.",
  "当前为本地网关，Codex CLI 经过 CodexManager 转发，请求日志、Token 和费用统计可用。":
    "Local gateway mode is active. Codex CLI is routed through CodexManager, so request logs, tokens, and cost analytics are available, including gateway-side hybrid routing.",
...
"个人资料已更新": "Profile updated",
  ...
  "上游模型": "Upstream model",
  "实际来源": "Actual source",
  "未经过本地网关的请求不会产生新的 CodexManager 请求日志": "Requests that bypass the local gateway do not create new CodexManager request logs",
  "这里仅展示历史网关请求；如需记录请求，请让 CLI 请求经过 CodexManager 本地网关。": "Only historical gateway requests are shown here. Route CLI requests through the CodexManager local gateway if you need request logging.",
  "去切换为本地网关": "Switch to local gateway",
  "仅网关流量": "Gateway traffic only",
  "账号直连模式下不会产生请求日志；本地网关或包含本地网关的混合路由才会记录。": "Direct account mode does not generate request logs. Local gateway mode, including gateway-side hybrid routing, is required for logging.",
  "当前 CLI 直连 OpenAI，未经过 CodexManager 的请求不会产生请求日志、Token 和费用统计。":
    "The current CLI connects to OpenAI directly. Requests that bypass CodexManager do not produce request logs, token counts, or cost analytics.",
  未分配: "Unassigned",
  ...
  "50 / 页": "50 / page",
  "100 / 页": "100 / page",
  "显示 {start}-{end} / {total}": "Showing {start}-{end} / {total}",
  刷新当前页余额: "Refresh current page balances",
  "条聚合 API": "aggregate APIs",
  测试当前页: "Test current page",
  当前页Token: "Current page tokens",
  "当前页 Token": "Current page tokens",
  当前页费用: "Current page cost",
  按当前页平台密钥累计: "Aggregated by platform keys on this page",
  按当前页我的密钥累计: "Aggregated by my keys on this page",
  ...
  "RPC requestlog/summary 超时：请求日志摘要查询超过 30 秒":
    "RPC requestlog/summary timed out: request log summary query exceeded 30 seconds",
  "RPC startup/snapshot 超时：启动快照查询超过 30 秒":
    "RPC startup/snapshot timed out: startup snapshot query exceeded 30 seconds",
};
