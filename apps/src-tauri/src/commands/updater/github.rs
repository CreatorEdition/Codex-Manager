...
mod tests {
    ...
    fn parse_release_assets_filters_repo_and_deduplicates() {
        let html = r#"
<a href="/CreatorEdition/Codex-Manager/releases/download/v0.1.8/CodexManager.exe">ok</a>
<a href="https://github.com/CreatorEdition/Codex-Manager/releases/download/v0.1.8/CodexManager.exe?download=1">dup</a>
<a href="/someone/else/releases/download/v0.1.8/not-ours.zip">skip</a>
"#;
        let assets = parse_release_assets_from_html(html, "CreatorEdition/Codex-Manager");
    ...
    fn release_asset_url_requires_target_repo() {
        assert!(normalize_release_asset_url(
            "/CreatorEdition/Codex-Manager/releases/download/v0.1.8/file.zip",
            "CreatorEdition/Codex-Manager"
        )
        .is_some());
        assert!(normalize_release_asset_url(
