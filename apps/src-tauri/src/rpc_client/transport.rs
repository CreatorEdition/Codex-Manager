...
mod tests {
    use super::{
        rpc_io_timeout, RPC_ACCOUNT_IMPORT_IO_TIMEOUT, RPC_BULK_USAGE_REFRESH_IO_TIMEOUT,
        RPC_DEFAULT_IO_TIMEOUT,
    };
    ...
    #[test]
    fn account_import_uses_extended_timeout() {
        let timeout = rpc_io_timeout("account/import", None);
        assert_eq!(timeout, RPC_ACCOUNT_IMPORT_IO_TIMEOUT);
    }
